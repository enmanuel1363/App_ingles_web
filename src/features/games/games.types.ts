...
export type CreateExerciseGameDTO = Omit<ExerciseGame, "id" | "created_at" | "updated_at">;
export type CreateGameStudentLogDTO = Omit<GameStudentLog, "id" | "completed_at">;
export type CreateGameRoomDTO = Omit<GameRoom, "id" | "created_at" | "updated_at">;
