...
export default function AudioChallengeForm({
  ...
  const options = content.options || (subtype === "male_or_female_voice" ? ["Male", "Female"] : ["", "", "", ""]);
  ...
  return (
    <div className="space-y-4">
      ...
      {subtype !== "male_or_female_voice" ? (
        ...
        <p className="text-xs text-slate-550 font-semibold italic">
          Options are automatically locked to "Male" and "Female".
        </p>
      )}
      ...
      <FormInput
        ...
        placeholder={subtype === "male_or_female_voice" ? "Male or Female" : "e.g. Correct phrase"}
